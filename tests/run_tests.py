...
def run_keyword_coverage_test(
    answer: str, required: List[str], optional: List[str] = None
    ...
    Returns:
        Dictionary containing coverage scores for required, optional, and total keywords
    """
    ans = answer.casefold()
