...
def call_model_non_stream(system_prompt: str, user_prompt: str, format: Optional[dict] = None) -> str:
    """
...
def call_model_stream(system_prompt: str, user_prompt: str) -> Generator[str, None, None]:
    """
