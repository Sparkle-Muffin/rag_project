...
from common.constants import QDRANT_COLLECTION_NAME
...
def create_prompt(user_prompt, context_files):
    ...
    context = search_answer_in_qdrant(collection_name=QDRANT_COLLECTION_NAME, query_embedding=query_embedding, context_files=context_files)
